...
use App\Listeners\SetEmailVerifiedAt;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Registrar listener para o evento UserActivated
        Event::listen(UserActivated::class, SetEmailVerifiedAt::class);
        ...
        // Comentado temporariamente para evitar problemas de memória
        /*
